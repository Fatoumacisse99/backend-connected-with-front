...
//   const { titre, ingredients, type, categorie_id } = req.body; // Include categoryName
...
//       await CategoryModel.getCategoryById(categoryName);
//     let categoryId;

//     if (existingCategory) {
//       // If category exists, use its ID
//       categoryId = existingCategorie.id;
//     } else {
//       // If category does not exist, create a new category using the Category model
//       const newCategory = await CategoryModel.createCategory(categorie_id);
...
//       ingredients,
//       type,
//       categorie_id: categoryId, // Add the category ID
//     };
